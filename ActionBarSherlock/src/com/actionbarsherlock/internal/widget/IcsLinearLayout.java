...
/** A simple extension of a regular linear layout that supports the divider API of Android 4.0+. The dividers are added adjacent to the children by changing
 * their layout params. If you need to rely on the margins which fall in the same orientation as the layout you should wrap the child in a simple
...
public class IcsLinearLayout extends NineLinearLayout {
	 ...
	 * 
	 * @param showDividers
	 *            One or more of {@link #SHOW_DIVIDER_BEGINNING}, {@link #SHOW_DIVIDER_MIDDLE}, or {@link #SHOW_DIVIDER_END}, or {@link #SHOW_DIVIDER_NONE} to
	 *            show no dividers. */
